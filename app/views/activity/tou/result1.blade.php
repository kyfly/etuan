...
<div class="container-fluid">
    <table class="table table-striped">
        ...
        <tr>
            ...
            <tr>
                <td class="firstTd">生命信息与仪器工程学院</td>
                <td class="secondTd">
                    <div class="progress">
                        <div class="progress-bar progress-bar-info"></div>
                    </div>
            ...
            <tr>
                <td class="firstTd">数字媒体与艺术设计学院</td>
                <td class="secondTd">
                    <div class="progress">
                        <div class="progress-bar progress-bar-info"></div>
                    </div>
