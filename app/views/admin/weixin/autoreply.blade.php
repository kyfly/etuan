        ...
        <div id="main" class="col-lg-9 col-md-9">
            ...
            <div>
                <button type="button" class="btn btn-primary btn-lg" style="letter-spacing: 2px"
                        data-toggle="modal" data-target="#addrulebox" id="btnAddRule" disabled="disabled">+添加规则
                </button>
                &nbsp;&nbsp;
                <button type="button" class="btn btn-warning btn-lg" id="btnOneKeyReg" disabled="disabled">一键添加报名表
                </button>
            </div>
            <div style="height: 20px"></div>
            <div class="alert alert-dismissible alert-info" id="loadingAlert" role="alert">
                <span id="topAlertStr">正在加载自动回复...</span>
            </div>
            ...
            <!-- 删除确认-->
            <div class="modal fade" id="delMsgModal" tabindex="-1" role="dialog" aria-labelledby="delMsgModal"
                 aria-hidden="true">
                <div class="modal-dialog">
