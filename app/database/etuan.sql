...
CREATE TABLE IF NOT EXISTS `etuan`.`mp_weixin` (
  ...
  `app_sercret` VARCHAR(50) NULL DEFAULT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
  `org_uid` INT NOT NULL,
  PRIMARY KEY (`mp_id`),
...
CREATE TABLE IF NOT EXISTS `etuan`.`mp_msg_news` (
  ...
  `news_from` ENUM('reg','vote','lottery','ticket','sucai') NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS `etuan`.`mp_qr_etuan` (
  ...
  `act_type` ENUM('reg','vote','ticket','lottery') NULL,
  `act_id` INT NULL,
  `qrcode_url` VARCHAR(250) NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
