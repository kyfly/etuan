...
CREATE TABLE IF NOT EXISTS `etuan`.`organization` (
  ...
  `type` ENUM('校级组织','职能社团','院级组织','校级社团','院级社团') NOT NULL,
...
-- -----------------------------------------------------
-- Table `etuan`.`ticket_old`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `etuan`.`ticket_old` (
  `ticket_id` INT NOT NULL AUTO_INCREMENT,
  `activity_name` VARCHAR(45) NULL,
  `start_time` VARCHAR(20) NULL,
  `ticket_total` INT NULL,
  `exclude_id` VARCHAR(20) NULL,
  PRIMARY KEY (`ticket_id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `etuan`.`ticket_1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `etuan`.`ticket_1` (
  `shanxun_id` VARCHAR(45) NOT NULL,
  `wx_uid` VARCHAR(50) NULL,
  `shanxun_pwd` VARCHAR(45) NULL,
  `Sno` INT NULL,
  `time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`shanxun_id`),
  INDEX `fk_ticket_1_wx_user1_idx` (`wx_uid` ASC),
  UNIQUE INDEX `wx_uid_UNIQUE` (`wx_uid` ASC),
  CONSTRAINT `fk_ticket_1_wx_user1`
    FOREIGN KEY (`wx_uid`)
    REFERENCES `etuan`.`wx_user` (`wx_uid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
